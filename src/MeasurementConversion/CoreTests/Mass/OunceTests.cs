...
namespace Jdn.Measurement.Core.Tests.Mass
{
    ...
    public class OunceTests
    {
        ...
        public void ToGrams()
        {
            var mass = this.GetMass(3.52739619m);
            Assert.IsTrue(mass.ToGrams() == 100m);
        }
        ...
        {
            var volume = GetMass(1.5m);
            Assert.IsTrue(volume.UnitOfMeasure == "Ounce");
        }
        ...
        {
            return WeightFactory.Ounces(value);
        }
    }
}
